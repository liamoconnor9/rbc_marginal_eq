...
For large $\Ra$, the advections of this maximum branch opposes the strong diffusion of the thin boundary layers. 
...
From a dynamical systems perspective, in the space of nonlinear solution trajectories, unstable orbits depart from MSTE and approach the global attractor (the compact manifold of states whose weighted-average agrees with experiments) on a viscous time-scale. This requires more CPU-hr to achieve relaxation when compared to the conventional linear initial condition \eq{EQ:linear_ic}.
