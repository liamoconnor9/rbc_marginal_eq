...
By definition, MUTE are unstable and would likely admit more diffuse boundary layer structures, requiring smaller $A^2$ (less advection) to satisfy the stability constraint and thereby reducing $\Nu$, $\langle |\vec{u}|^2 \rangle_{\mathcal{D}}$ and possibly $\beta$.
