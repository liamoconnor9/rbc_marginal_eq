...
\end{equation}
Once constructed we use each subsequent guess to update the Jacobian iteratively according to Broyden's method for root-finding in multi-dimensional functions \cite{Broyden}.
...
Presumably this is due to the coupling of $W(z)$ and $\theta(z)$ with $\bar{T}$.
