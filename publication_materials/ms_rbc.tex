...
The simplest approach is to initialize the perturbations to low amplitude, and evolve them together with the background (this is, e.g., the approach of \cite{marston2016} and many others).
...
We then calculate the largest eigenvalues for the $\overline{T}_{\rm{diff}}$ and $\overline{T}_{\rm{adv}}$ profiles, $\sigma_{\rm{diff}}$ and $\sigma_{\rm{adv}}$.
