...
\begin{abstract}
Reduced models give us some understanding of the behavior of complicated systems. We derive a quasilinear form of the Boussinesq Rayleigh-B\'enard equations from the classical linear stability analysis. Eigenfunction amplitudes are obtained by requiring marginal-stability. We obtain symmetric thermally-equilibrated states and analyze their properties. Such states are compared with statistically-steady 2-dimensional Rayleigh-Be\'nard convection simulations; marginally-stable thermally-equilibrated states have thinner boundary layers and larger Nusselt numbers $\Nu$ which scale like $\Nu \sim Ra^{1/3}$. We initialize 2-dimensional simulations with solutions to the quasilinear problem;
